    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyweightTrackers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BodyweightTrackers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalorieTrackers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CalorieTrackers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MacroNutrients = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutSchedules_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercise_Workouts_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exercise_Workouts_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodyweightTrackers_UserId",
                table: "BodyweightTrackers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CalorieTrackers_UserId",
                table: "CalorieTrackers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercise_Workouts_ExerciseId",
                table: "Exercise_Workouts",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_Exercise_Workouts_WorkoutId",
                table: "Exercise_Workouts",
                column: "WorkoutId");
